...
for desc in description:
    print(desc)
    cloudy_file_list = glob.glob(in_dir+direction+'_90m_clearcon/'+desc+'/cloudy_AST_L1T**.csv')
    for cloudy_file in cloudy_file_list:
        ...
        clear_file = in_dir+direction+'_90m_clearcon/'+desc+'/clear_'+AST_file
...
all_clear_nofil['transect_length'] = all_clear_nofil['count'] * 90e-3
all_clear = pd.concat(clear_li, axis=0, ignore_index=True)
all_clear['transect_length'] = all_clear['count'] * 90e-3
...
plt.ylabel('Counts')
plt.savefig('/data/keeling/a/mdevera2/macrost/paper_fig/nofil_nolarge_all_transect_'+direction+'_length_test_90m_clearcon.png', bbox_inches='tight')
plt.close()
...
plt.xlabel('Length (km)')
plt.ylabel('Counts')
plt.savefig('/data/keeling/a/mdevera2/macrost/paper_fig/nolarge_all_transect_'+direction+'_length_test_90m_clearcon.png', bbox_inches='tight')
plt.close()
...
plt.ylim(0,1)
plt.xlim(0,10)
plt.savefig('/data/keeling/a/mdevera2/macrost/nofil_nolarge_cloudy_transect_'+direction+'_test_90m_clearcon.png', bbox_inches='tight')
plt.close()
...
plt.ylim(0,1)
plt.xlim(0,10)
plt.savefig('/data/keeling/a/mdevera2/macrost/nofil_nolarge_clear_transect_'+direction+'_test_90m_clearcon.png', bbox_inches='tight')
plt.close()
'''
...
plt.ylim(0,1)
plt.xlim(0,10)
plt.savefig('/data/keeling/a/mdevera2/macrost/paper_fig/nolarge_cloudy_transect_'+direction+'_test_90m_clearcon.png', bbox_inches='tight')
plt.close()
...
plt.ylim(0,1)
plt.xlim(0,10)
plt.savefig('/data/keeling/a/mdevera2/macrost/'+folder+'/nolarge_cloudy_transect_'+direction+'_test_90m_clearcon_05.png', bbox_inches='tight')
plt.close()
...
plt.ylim(0,1)
plt.xlim(0,10)
plt.savefig('/data/keeling/a/mdevera2/macrost/'+folder+'/nolarge_cloudy_transect_'+direction+'_test_90m_clearconfull_05line.png', bbox_inches='tight')
plt.close()
...
weights = np.ones_like(cloudy_less7['transect_length'])/float(len(cloudy_less7['transect_length']))
n, bins, patches = plt.hist(x=cloudy_less7['transect_length'], bins=bins_list, histtype=u'step', weights=weights, label='ASTER')
plt.stairs(n/bin_center, bins_list)
plt.stairs(diam, bins_list)
plt.xscale('log')
plt.yscale('log')
plt.grid()
plt.xlabel('Length (km)')
...
plt.ylim(0,1)
plt.xlim(0,10)
plt.savefig('/data/keeling/a/mdevera2/macrost/simple_nolarge_cloudy_transect_'+direction+'_test_90m.png', bbox_inches='tight')
plt.close()
...
plt.ylim(0,1)
plt.xlim(0,10)
plt.savefig('/data/keeling/a/mdevera2/macrost/paper_fig/nolarge_cloudy_hsrl_test_90m_clearcon.png', bbox_inches='tight')
plt.close()
...
idx = np.where(nrsp > 0)
pars, cov = curve_fit(f=line_law, xdata=np.log(np.array(bin_center)[idx]), ydata=np.log(nrsp[idx]))
...
plt.ylim(0,1)
plt.xlim(0,10)
plt.savefig('/data/keeling/a/mdevera2/macrost/paper_fig/nolarge_cloudy_rsp_test_90m_clearcon.png', bbox_inches='tight')
plt.close()
...
plt.ylim(0,1)
plt.xlim(0,10)
plt.savefig('/data/keeling/a/mdevera2/macrost/paper_fig/nolarge_cloudy_transect_'+direction+'_hsrl_rsp_test_90m_clearcon.png', bbox_inches='tight')
plt.close()
...
plt.ylim(0,1)
plt.xlim(0,10)
plt.savefig('/data/keeling/a/mdevera2/macrost/nolarge_clear_transect_'+direction+'_test_90m_clearcon.png', bbox_inches='tight')
plt.close()
...
plt.ylim(0,1)
plt.xlim(0,10)
plt.savefig('/data/keeling/a/mdevera2/macrost/nolarge_clear_hsrl_test_90m_clearcon.png', bbox_inches='tight')
plt.close()
...
plt.ylim(0,1)
plt.xlim(0,10)
plt.savefig('/data/keeling/a/mdevera2/macrost/nolarge_clear_rsp_test_90m_clearcon.png', bbox_inches='tight')
plt.close()
...
plt.ylim(0,1)
plt.xlim(0,10)
plt.savefig('/data/keeling/a/mdevera2/macrost/nolarge_clear_transect_'+direction+'_hsrl_rsp_test_90m_clearcon.png', bbox_inches='tight')
plt.close()
